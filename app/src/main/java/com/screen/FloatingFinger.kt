...
//        emptyView.setImageResource(R.drawable.icon_answer_start)
//        emptyView.setBackgroundColor(Color.TRANSPARENT)
//        emptyView.visibility = View.INVISIBLE
//
//        secondRow.addView(emptyView)
//        secondRow.addView(browserButton)

        firstRow.addView(browserButton)

        frameLayout.addView(firstRow)
        frameLayout.addView(secondRow)
        ...
        paramsF.x = 850
        paramsF.y = 220
//        mWindowManager.addView(frameLayout, paramsF)

//        handsUpButton.isClickable = false
...
//                                    startActivity(intentFor<WebActivity>()
    ...
    override fun handSupSuccess(data: HandSupBean) {
        ToastGlobal.showToast("举手成功" + data.ID.toString())
